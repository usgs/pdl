...
public class EventTest {
	...
	public void testPreferredProductProperties() {
		...
		p1.setEventMagnitude(BigDecimal.valueOf(4.9));
		p1.setEventSource("source1");
		p1.setEventSourceCode("source1code");
		p1.setEventLatitude(BigDecimal.valueOf(1.2));
		p1.setEventLongitude(BigDecimal.valueOf(2.3));
		...
		p2.setEventMagnitude(BigDecimal.valueOf(5.0));
		p2.setEventSource("source2");
		p2.setEventSourceCode("source2code");
		p2.setEventLatitude(BigDecimal.valueOf(1.2));
		p2.setEventLongitude(BigDecimal.valueOf(2.3));
		...
		p3.setEventMagnitude(BigDecimal.valueOf(5.1));
		p3.setEventSource("source3");
		p3.setEventSourceCode("source3code");
		p3.setEventLatitude(BigDecimal.valueOf(1.2));
		p3.setEventLongitude(BigDecimal.valueOf(2.3));
		...
		p1.setEventMagnitude(BigDecimal.valueOf(4.9));
		p1.setEventSource("source1");
		p1.setEventDepth(BigDecimal.valueOf(10));
		p1.setEventLatitude(BigDecimal.valueOf(10));
		p1.setEventLongitude(BigDecimal.valueOf(10));
		...
		p2.setEventMagnitude(BigDecimal.valueOf(5.0));
		p2.setEventSource("source2");
		p2.setEventDepth(BigDecimal.valueOf(15));
		p2.setEventLatitude(BigDecimal.valueOf(15));
		p2.setEventLongitude(BigDecimal.valueOf(15));
		...
		p3.setEventMagnitude(BigDecimal.valueOf(5.1));
		p3.setEventSource("source3");
		p3.setEventDepth(BigDecimal.valueOf(15));
		p3.setEventLatitude(BigDecimal.valueOf(15));
		p3.setEventLongitude(BigDecimal.valueOf(15));
